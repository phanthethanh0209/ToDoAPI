...
namespace TodoListAPI.Repositories
{
    public interface IRepositoryBase<T> where T : class
    {
        ...
        Task<IEnumerable<T>> GetAllWithPaginationAsync(Expression<Func<T, bool>> expression = null, int pageNumber = 1, int limit = 10);
    ...
    public class RepositoryBase<T> : IRepositoryBase<T> where T : class
    {
        ...
        public async Task<IEnumerable<T>> GetAllWithPaginationAsync(Expression<Func<T, bool>> expression = null, int pageNumber = 1, int limit = 10)
        {
            IQueryable<T> query = _dbSet;
            if (expression != null)
            {
